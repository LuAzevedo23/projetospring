package com.luazevedo.projetospring.entities;
...
public class Game {
    ...
    //Método criado para comparar se dois games são iguais ou não, por exemplo
    //game numa lista, sendo assim conseguimos comparar
    @Override
